...
def generate_answer(pdf_content,
    ...
    Keep it short and to the point. The questions are generated by AI as the top questions that can be asked on this content;
    Make sure the answers are not covering things asked in other questions.
    do not inlcude any links.
